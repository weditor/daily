...
> 虽然这里 new 了一个空 User, 但是在 apply 里面有初始化，
...
> 我只是不太希望后面开发的人无意间在 语句 1/语句 2 中间插入一些无关的代码破坏这种整体性。
...
> 我知道把 run 里面的东西提出来也一样。里面这段代码只是为了完成一个简单的 X 功能，只不过实现它还是需要那么 4~5 行代码的，
